...
class AccountTest {
	...
	@Test
	void testForNewConstructorOfAccountStatus() {
		var acc = new Account("tr1", 10_000, AccountStatus.CLOSED);
	}
	
	@Test
	void testSetterGetterMethodsforAccountStatusVariable() {
		var acc = new Account("tr1", 10_000);
	...
	@Test
	void toStringShouldAppendAccountStatus() {
		var acc = new Account("tr1", 10_000);
		//String result = "Account [iban=" + acc.getIban() + ", balance=" + acc.getBalance() + ", status=" + acc.getStatus() + "]";
		//assertTrue(result, acc.toString());
		String result = "Account [iban=" + acc.getIban() + ", balance=" + acc.getBalance() + ", status=" + AccountStatus.ACTIVE + "]";
		assertEquals(result, acc.toString());

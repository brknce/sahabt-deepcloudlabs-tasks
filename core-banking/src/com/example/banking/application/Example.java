...
public class Example {
	...
	public static void main(String[] args) {
		...
		jack.addAccount("tr1",  new Account("tr1", 10_000));
		jack.addAccount("tr2", new Account("tr2", 20_000));
		jack.addAccount("tr3", new Account("tr3", 30_000));
		kate.addAccount("tr4", new Account("tr4",20_000));
